...
blended_image = zeros(pad_rows, pad_cols, 3);
...
for row_start = 1:overlap:pad_rows
    for col_start = 1:overlap:pad_cols
        ...
        % Compute the histogram with contrast limiting for all channels
        ...
        % Add the weighted tile to the blended image for all channels
        for ch = 1:3
